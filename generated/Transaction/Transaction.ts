...
export class LockedProfitDegradationUpdated extends ethereum.Event {
  get params(): LockedProfitDegradationUpdated__Params {
    return new LockedProfitDegradationUpdated__Params(this);
  }
}

export class LockedProfitDegradationUpdated__Params {
  _event: LockedProfitDegradationUpdated;

  constructor(event: LockedProfitDegradationUpdated) {
    this._event = event;
  }
...
export class Transaction__strategiesResult {
  ...
  getMinDebtPerHarvest(): BigInt {
    return this.value3;
  }

  getMaxDebtPerHarvest(): BigInt {
    return this.value4;
  }
...
export class Transaction extends ethereum.SmartContract {
  ...
  lockedProfitDegradation(): BigInt {
    let result = super.call(
      ...
      "lockedProfitDegradation():(uint256)",
      []
    );
  ...
  try_lockedProfitDegradation(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "lockedProfitDegradation",
      "lockedProfitDegradation():(uint256)",
      []
...
export class SetLockedProfitDegradationCall extends ethereum.Call {
  get inputs(): SetLockedProfitDegradationCall__Inputs {
    return new SetLockedProfitDegradationCall__Inputs(this);
  }

  get outputs(): SetLockedProfitDegradationCall__Outputs {
    return new SetLockedProfitDegradationCall__Outputs(this);
  }
}

export class SetLockedProfitDegradationCall__Inputs {
  _call: SetLockedProfitDegradationCall;

  constructor(call: SetLockedProfitDegradationCall) {
    this._call = call;
  }

  get degradation(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }
}

export class SetLockedProfitDegradationCall__Outputs {
  _call: SetLockedProfitDegradationCall;
